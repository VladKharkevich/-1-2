...
namespace Faker
{
    public class TypeGenerator
    {
        ...
        public TypeGenerator()
        {
            string[] pluginPaths =
            {
                @"GeneratorOfBasicTypes\bin\Debug\netcoreapp3.1\GeneratorOfBasicTypes.dll",
                @"GeneratorOfDateTimes\bin\Debug\netcoreapp3.1\GeneratorOfDateTimes.dll"
            };
        ...
        public object Generate(Type type)
        {
            ...
            {
                if (generator.fSupportedTypes.Contains(type))
                {
